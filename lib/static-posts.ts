...
export const STATIC_POSTS: Post[] = [
  {
    ...
    excerpt:
      "Standing at 8,611 metres, K2 is the world's second-highest and most dangerous peak. The trek to its base camp through the Karakoram range is a once-in-a-lifetime journey through raw, breathtaking wilderness.",
...
The reward? Standing at Concordia, surrounded by four 8,000m peaks — K2, Broad Peak, Gasherbrum I and II — is an experience that will stay with you forever.`,
    image_url: 'https://picsum.photos/seed/k2-pakistan/1200/800',
    category: 'Adventure',
    author: 'Ahmad Fraz',
  ...
  {
    id: '2',
    slug: 'lahore-mughals-and-food',
    title: 'Lahore: The City of Gardens, Mughals & Incredible Food',
    excerpt:
      "Lahore is Pakistan's cultural heartbeat — a city where 17th-century Mughal architecture stands alongside buzzing bazaars, and where the food is so good locals say \"Lahore Lahore aye.\"",
...
Lahore has excellent **rickshaws**, **ride-hailing apps** (InDrive, Bykea), and the **Orange Line Metro** connecting key areas.`,
    image_url: 'https://picsum.photos/seed/lahore-badshahi/1200/800',
    category: 'Culture',
    author: 'Ahmad Fraz',
  ...
  {
    id: '3',
    slug: 'hunza-valley-paradise-found',
    title: 'Hunza Valley: Paradise Found in the Karakoram',
    excerpt:
      "Nestled between the Karakoram, Hindu Kush and Himalayan ranges, Hunza Valley is Pakistan's most photographed destination — and for good reason. Cherry blossoms, ancient forts, and views of Rakaposhi will leave you speechless.",
...
Fly **Islamabad → Gilgit** (55 minutes), then drive 2 hours to Karimabad. Alternatively, the **Karakoram Highway** drive from Islamabad takes 14–16 hours but passes through some of the world's most dramatic scenery.`,
  ...
  {
    id: '4',
    slug: 'karachi-street-food-guide',
    title: 'Karachi Street Food Guide: 20 Dishes You Must Try',
    excerpt:
      "Pakistan's largest city is a melting pot of cultures, and nowhere is this more evident than in its street food. From Boat Basin to Burns Road, Karachi's food scene is unlike anything else in the world.",
...
Karachi's street food is an adventure. Go hungry, go curious, and go often.`,
    image_url: 'https://picsum.photos/seed/karachi-food/1200/800',
    category: 'Food',
    author: 'Ahmad Fraz',
  ...
  },
  {
    ...
    excerpt:
      "Fairy Meadows is the most beautiful alpine meadow in Pakistan — a flat, flower-filled expanse at 3,300m with Nanga Parbat, the world's 9th highest peak, as its dramatic backdrop.",
...
- Clear mornings are essential — clouds typically roll in by early afternoon`,
    image_url: 'https://picsum.photos/seed/fairy-meadows/1200/800',
    category: 'Adventure',
    author: 'Ahmad Fraz',
  ...
  {
    id: '6',
    slug: 'mohenjo-daro-indus-civilization',
    title: 'Mohenjo-daro: Walking Through a 5,000-Year-Old Civilization',
    excerpt:
      "One of the world's earliest urban settlements, Mohenjo-daro in Sindh was a masterpiece of city planning that predates the Roman Empire by 2,000 years. Visiting it is a journey to the very dawn of human civilization.",
...
**October to February** — Sindh summers are brutally hot (45°C+). Winter mornings are cool and the light is perfect for photography.`,
  ...
  {
    id: '7',
    slug: 'deosai-plains-roof-of-the-world',
    title: 'Deosai Plains: The Roof of the World in Full Bloom',
    excerpt:
      "At an average elevation of 4,114m, Deosai is the world's second-highest plateau. In summer, it transforms into a vast carpet of wildflowers stretching to the horizon — a landscape so alien it barely feels like Earth.",
...
- Altitude sickness is possible — acclimatize in Skardu first`,
  ...
  {
    id: '8',
    slug: 'peshawar-silk-road',
    title: 'Peshawar: Where the Silk Road Lives On',
    excerpt:
      'One of the oldest continuously inhabited cities in the world, Peshawar sits at the gateway to the Khyber Pass. Its bazaars sell everything from hand-embroidered textiles to antique Afghan rifles — and the food is extraordinary.',
...
- **Train** from Lahore (5 hours on the Khyber Mail)`,
    image_url: 'https://picsum.photos/seed/peshawar-bazaar/1200/800',
    category: 'Culture',
    author: 'Ahmad Fraz',
